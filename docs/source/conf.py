...
# Just remember that if serving this in GH pages, Jekyll ignores dirs
# starting with underscore, unless you set .nojekyll IIRC
...
# mapping here for appleseed docs which will be split in developer, user
# and other ingrations

# appleseed user docs
# appleseed developers docs
# appleseed maya
# appleseed max
# ....
